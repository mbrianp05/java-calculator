...
public class CalculatorScreen extends JFrame {
	...
	private double getCurrentNumber() {
		...
		try {
			...
			JOptionPane.showMessageDialog(null, "La entrada debe ser un n�mero", "Error", JOptionPane.ERROR_MESSAGE);
		} finally {
	...
	private void doCalculation() {
		...
		case Div:
			if (current != 0) {
				...
				JOptionPane.showMessageDialog(null, "La divisi�n entre 0 no est� definida", "Error", JOptionPane.ERROR_MESSAGE);
			}
			break;
		case Prod:
			textField.setText(Double.toString(current * oldNumber));
